...
# In newer transformers versions, there's only one MistralAttention class
# that handles different implementations internally
MISTRAL_ATTENTION_CLASSES = {
    "eager": ModifiedMistralAttention,
    "flash_attention_2": ModifiedMistralAttention,
    "sdpa": ModifiedMistralAttention,
}
