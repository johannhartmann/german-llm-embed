...
echo "=== Teuken-7B German Embedding Model Setup ==="
echo
...
conda create -n teuken2vec python=3.12 -y
...
# Clone LLM2Vec if not already present
if [ ! -d "llm2vec" ]; then
    echo "Cloning LLM2Vec repository..."
    git clone https://github.com/McGill-NLP/llm2vec.git
else
    echo "LLM2Vec repository already exists."
fi
...
echo
echo "To get started:"
echo "1. conda activate teuken2vec"
